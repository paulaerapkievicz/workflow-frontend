...
import { whatsappLink, proposalEmailLink, CONTACT_EMAIL, COMPANY_CNPJ, COMPANY_CITY } from "@/src/config/landingContact";
...
const WHATSAPP_CHAT_MESSAGE = "Olá! Vim pelo site e queria falar com a Workflow.";
              ...
              {authenticated ? (
                ...
                <>
                  <div className={s.actions}>
                    ...
                    <a href={whatsappLink(WHATSAPP_CHAT_MESSAGE)} className={s.btnGhost}>
                      Falar no WhatsApp
                    </a>
                  </div>
            ...
            <section className={`${s.wrap} ${s.ctaBand}`}>
              <div className={s.ctaInner}>
                ...
                <div className={s.ctaActions}>
                  ...
                  <a href={whatsappLink(WHATSAPP_CHAT_MESSAGE)} className={s.ctaBtnGhost}>
                    Chamar no WhatsApp
                  </a>
                </div>
              </div>
            ...
            <footer className={s.landingFooter}>
              <div className={`${s.wrap} ${s.footerInner}`}>
                ...
                <div className={s.footerCol}>
                  <h4>Contato</h4>
                  <a href={whatsappLink(WHATSAPP_CHAT_MESSAGE)}>WhatsApp comercial</a>
